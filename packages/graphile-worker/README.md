...
- [@golevelup/nestjs-graphile-worker](#golevelupnestjs-graphile-worker)
...
```typescript
import { RabbitMQModule } from '@golevelup/nestjs-graphile-worker';
...
```typescript
import { isRabbitContext } from '@golevelup/nestjs-graphile-worker';
...
```typescript
import { RabbitRPC } from '@golevelup/nestjs-graphile-worker';
...
```typescript
import { RabbitSubscribe } from '@golevelup/nestjs-graphile-worker';
import { Injectable } from '@nestjs/common';
